...
const getMasters = searchString => fetch(`${API_URL + '/masters' + (searchString ? `?name=${searchString}` : '')}`, {method: GET, headers:{'Authorization':`Bearer_${getToken()}`}}).then(handleResponse);
