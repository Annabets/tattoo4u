...
public class Api006_MakeSureCurrentUserApiMethodWorkCorrectly {
    @Test
    public void testScenario() {
        ...
        CustomLogger.makeStepLog(2, "Making api current user request");
        Assert.assertEquals(ApiSiteRequests.makeApiCurrentUserAndGetStatus(request.get(ApiKeysConstants.TOKEN).asText()), ResponsesStatusConstants.STATUS_OK, "Not right status!");
    }
}
